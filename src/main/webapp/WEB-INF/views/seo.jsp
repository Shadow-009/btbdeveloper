                    ...
                    <div class="content-side col-lg-8 col-md-12 col-sm-12">
                        <div class="service-details">
                            ...
                            <div class="text-content">
                                ...
                                <p>SEO writing is the implementation of keywords and keyphrases within web content. Copywriters and marketers use SEO to increase their site's organic visibility and SERP rankings. The best way to write for SEO is to pair high-quality copy with targeted search terms.</p>
                                <div class="featured">
                                    <div class="row clearfix">
                                ...
                                <p>It’s important to keep in mind that if search engine traffic is your only goal, your results will probably suffer. In order to please both the search engines (who will reward you with high rankings over time) and potential customers and return visitors, you need to offer value above and beyond search engine optimization.</p>
                                <p class="last">If you’ve been producing content in a haphazard manner, hoping and praying that some of it eventually ranks, it’s time to buckle down and commit to a more methodical SEO content strategy for the web.</p>
                            </div>
                        </div>
                    </div>
