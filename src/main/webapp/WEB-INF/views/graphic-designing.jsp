...
<head>
    <meta charset="utf-8">
    <title>BTB Developer | graphic-designing</title>
    <!-- Stylesheets -->
                    ...
                    <div class="content-side col-lg-8 col-md-12 col-sm-12">
                        <div class="service-details">
                            ...
                            <div class="text-content">
                                ...
                                <p>Graphic design is a craft where professionals create visual content to communicate messages.and page layout techniques, designers use pictures to meet users’ specific needs.So here they are – the most acclaimed and awarded graphic design websites and portfolios across the internet, featuring professionals from all over the world and brought to you in alphabetical order. </p>
                                <div class="featured">
                                    <div class="row clearfix">
                                ...
                                <p class="last">Your business needs an effective visual strategy in order to make you stand out from the crowd. It’s not enough to just rely on exceptional content. You make your marketing efforts more impactful by pairing valuable content with a visually appealing design. We coordinate with you to make sure your design project comes in on-budget and on-time.</p>
                            </div>
                        </div>
                    </div>
