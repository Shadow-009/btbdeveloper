...
<head>
    <meta charset="utf-8">
    <title>BTB Developer | ui/ux</title>
    <!-- Stylesheets -->
                    ...
                    <div class="content-side col-lg-8 col-md-12 col-sm-12">
                        <div class="service-details">
                            ...
                            <div class="text-content">
                                ...
                                <p>“UX” stands for “user experience.” A user’s experience of the app is determined by how they interact with it.User experience is determined by how easy or difficult it is to interact with the user interface elements that the UI designers have created.</p>
                                <p class="last"> The UI teams adapt their designs to fit the new layout. Constant communication and collaboration between UI and UX designers help to assure that the final user interface looks as good as it can, while also operating efficiently and intuitively.</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="sidebar-widget services">
                                <div class="widget-inner">
                                    ...
                                    <ul>
                                        ...
                                        <li class="active"><a href="ui-designing">UI/UX Designing</a></li>
                                    </ul>
                                </div>
                            </div>
