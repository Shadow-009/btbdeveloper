...
<head>
    <meta charset="utf-8">
    <title>BTB Developer | web-development</title>
    <!-- Stylesheets -->
                    ...
                    <div class="content-side col-lg-8 col-md-12 col-sm-12">
                        <div class="service-details">
                            ...
                            <div class="text-content">
                                ...
                                <p>A more comprehensive list of tasks to which Web development commonly refers, may include Web engineering, Web design, Web server and network security configuration, and e-commerce development.Web development refers to building, creating, and maintaining websites. It includes aspects such as web design, web publishing, web programming, and database management.</p>
                                <div class="featured">
                                    <div class="row clearfix">
                        ...
                        <aside class="sidebar blog-sidebar">
                            ...
                            <div class="sidebar-widget services">
                                <div class="widget-inner">
                                    ...
                                    <ul>
                                        <li class="active"><a href="web-development">Website Development</a></li>
                                        <li><a href="graphic-designing">Graphic Designing</a></li>
                                        <li><a href="digital-marketing">Digital Marketing</a></li>
                                        <li><a href="seo">SEO & Content Writting</a></li>
                                        <li><a href="app-development">App Development</a></li>
