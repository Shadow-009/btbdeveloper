        ...
        <section class="login-wrapper">
            ...
            <div class="login-content">
                <div class="login-content__inner">
				    ...
				    <form action="resetpassword" style="align-content: center;">
				        password:<input type="text" name="password" placeholder="type password here">
				        confirm password:<input type="text" name="confirmpassword" placeholder="type confirm password here">
				        <div class="logo text-center" style="margin-top: 0px"><input type="submit" value="submit"></div>
				    </form>
