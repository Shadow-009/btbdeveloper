...
<head>
    <meta charset="utf-8">
    <title>BTB Developer| Registration</title>
    <!-- Stylesheets -->
        ...
        <section class="login-wrapper">
            ...
            <div class="login-content">
                <div class="login-content__inner">
                    <div class="logo-box">
                        <div class="logo text-center"><a href="index.jsp"
                                title="Btb developer"><img src="images/logo-dark.png"
                                    width="134" id="dLogo" class="main-logo" alt="btb developer"
                    ...
                    ${emailerror }
                        <div class="row">
                            <div class="col-md-12">
                                <input type="text" placeholder="Your Name *" name="userName" autocomplete="" autofocus="autofocus">
                            </div><!-- /.col-md-12 -->
                            <div class="col-md-12">
                                <input type="text" placeholder="Enter Email Address *" name="userEmail">
                            </div><!-- /.col-md-12 -->
                            <div class="col-md-12">
