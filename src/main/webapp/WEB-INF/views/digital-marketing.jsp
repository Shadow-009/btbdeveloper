...
<head>
    <meta charset="utf-8">
    <title>BTB Developer | digital-marketing</title>
    <!-- Stylesheets -->
                    ...
                    <div class="content-side col-lg-8 col-md-12 col-sm-12">
                        <div class="service-details">
                            ...
                            <div class="text-content">
                                ...
                                <p>You may be having the best product in the market at the best price posible, but what is it worth of no one knows about your product? 
Major problem with businesses both offline and online is their market reach and lack of standout marketing. We bring to you a all in one solution the morden age marketing also know as ' Digital Marketing '. 
 </p>
                                <div class="featured">
                                    <div class="row clearfix">
                                ...
                                <p>Digital Firefly Marketing provides custom content driven by trends and reflective of your brand.  Our staff work with you as a part of your team and take care of website content so that you can focus on your brand.</p>
                                <p class="last">Creating valuable content is one of the keys to getting found on the Internet. Good content from researched  keywords increases the amount of traffic from search engines and builds your audience. Contact us today for a free website content audit to learn more about what we can do for you.</p>
                            </div>
                        </div>
                    </div>
