...
<head>
    <meta charset="utf-8">
    <title>BTB Developer | services</title>
    <!-- Stylesheets -->
            ...
            <div class="auto-container">
                ...
                <div class="work-tabs tabs-box">
                    ...
                    <ul class="tab-btns tab-buttons clearfix">
                        ...
                        <li data-tab="#tab-3" class="tab-btn"><span>Lets make ‘ A BRAND ’</span></li>
                    </ul>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="text-col col-lg-7 col-md-6 col-sm-12">
                                    <div class="inner">
                                        <div class="content">
                                            <div class="text">
                                                <p>We employ some of the market's leading technologies to ensure our services outperform your expectations. </p>
                                                <p class="theme_color">If you desire something thats not mentioned here please let us know, we will be more than happy to help you out  </p>
                                                <ul>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="text-col col-lg-7 col-md-6 col-sm-12">
                                    <div class="inner">
                                        <div class="content">
                                            <div class="text">
                                                <p>We won't promise you a 24/7 immediate assistance cause we all know even microsoft has Sundays off, but what we can do is guarantee you that whatever your issue is it will be addressed within 24 hours of your complaint.</p>
                                                <p class="theme_color">You can contact us on </p>
                                                <ul>
                                                    <li>call</li>
                                                    <li>email</li>
                                                    <li>chatbot</li>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="text-col col-lg-7 col-md-6 col-sm-12">
                                    <div class="inner">
                                        <div class="content">
                                            <div class="text">
                                                <p>Well now you know more about us than what our parents do so what are you waitting for, let's join hands and create the next big brand story. We believe in your product / services like you did when it all began and thats why we wanna be a part of your success story.</p>
                                                <p class="theme_color">We assure you the only regret you will have after working with us is “ if only we could have met a lot earlier “ </p>
                                                <ul>
...
<!-- Mirrored from layerdrops.com/linoorhtml/services by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 May 2021 07:59:44 GMT -->
</html>