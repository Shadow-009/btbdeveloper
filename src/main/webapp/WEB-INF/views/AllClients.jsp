		...
		<section class="shop-page">
			...
			<div class=container>
				<table class="table table-hover" title="">
 					<thead><tr colspan="9">YOUR CLIENTS </tr></thead>
					  <thead>
					    <tr>
					 ...
					 <c:forEach items="${users}" var="list">
                        <tr>
                            <td> <a href="ordersbyuser?email=${list.userEmail }"> ${list.userName}</a></td>
							<td><a href="ordersbyuser?email=${list.userEmail }">${list.userEmail}</a></td>
						</tr>
                    </c:forEach>
			  		</tbody>
				</table>
